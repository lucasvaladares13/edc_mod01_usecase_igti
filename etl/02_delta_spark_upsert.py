...
enemnovo = (
    ...
    .load("s3://datalake-igti-tf-usecase-01-516190547158/staging-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-igti-tf-usecase-01-516190547158/staging-zone/enem")
